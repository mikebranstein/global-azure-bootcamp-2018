...
var RecognizerConfig = /** @class */ (function () {
    function RecognizerConfig(platformConfig, recognitionMode, language, format, baseURL) {
    ...
    Object.defineProperty(RecognizerConfig.prototype, "BaseURL", {
        get: function () {
            return this.baseURL;
        },
        enumerable: true,
...
var SpeechConnectionFactory = /** @class */ (function () {
    function SpeechConnectionFactory() {
        ...
        this.Create = function (config, authInfo, connectionId) {
            // setup baseURL
            Exports_2.Storage.Local.GetOrAdd("Host", config.BaseURL);
            var endpoint = "";
    ...
    Object.defineProperty(SpeechConnectionFactory.prototype, "Host", {
        get: function () {
            return Exports_2.Storage.Local.GetOrAdd("Host", "wss://1a4467c35d614039add5e706567a44da.api.cris.ai");
        },
        enumerable: true,
        configurable: true
    });
